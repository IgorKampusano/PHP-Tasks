...
switch ($codeError) {
    ...
    case 2:
        var_dump("Что-то пошло не так как надо, но мы этого не ждали");
        break;
    case 3:
        var_dump("Я в домике");
        break;
...
$foods = ["Яблоко", "Клубника", "Апельсин", "Кабачок", "Патиссон", "Банан", "Арбуз", "Картошка", "Лягушачьи лапки"];
...
switch ($foods[$foodItem]) {
    ...
    case "Клубника":
        $foodType = "Ягода";
        var_dump("Выбранный продукт {$foods[$foodItem]} - это {$foodType}");
        break;
    case "Яблоко":
    case "Апельсин":
    case "Банан":
